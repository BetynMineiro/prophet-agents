...
public class CreatePipelineProjectRequestValidator : IValidator<CreatePipelineProjectRequest>
{
    public ValidationResult Validate(CreatePipelineProjectRequest? value)
    {
